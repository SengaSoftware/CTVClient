...
public class VectortvOffer extends Vector<tvOffer> implements KvmSerializable {
    
    
    public VectortvOffer(){}
    
    public VectortvOffer(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
